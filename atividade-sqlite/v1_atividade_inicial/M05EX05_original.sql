-- ============================================================
-- ATIVIDADE INICIAL DE SQLITE (MÓDULO 05 - ALURA 2025)
...
-- 6) Atualize o salário dos funcionários de "TI" para 7500 na tabela funcionários.
UPDATE tabelafuncionarios SET salario = 7500.00 WHERE departamento = 'TI';

-- 7) Delete da tabela funcionários todos os registros de funcionários que ganham 4000,00.
...
SELECT * FROM tabelafuncionarios WHERE departamento = 'Vendas' and salario > 6000.00;
...
-- 9.a) Insira 3 registros na tabela projetos e em seguida selecione todos os projetos cujo id_cliente seja igual a 2. 
